...
- Supports more than 140+ deployment destinations (e.g., Kubernetes, CDN, WAF, load balancers, etc. [Check out full providers](/docs/reference/providers#supported-hosting-providers)).
