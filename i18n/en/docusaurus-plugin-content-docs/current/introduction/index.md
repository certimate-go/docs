...
- Supports more than 120+ deployment targets (e.g., Kubernetes, CDN, WAF, load balancers, etc. [Check out full providers](/docs/reference/providers#supported-hosting-providers)).
