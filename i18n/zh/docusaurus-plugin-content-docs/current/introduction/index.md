...
- 支持 70+ 域名托管商（如阿里云、腾讯云、AWS、Cloudflare、GoDaddy 等，[点此查看完整清单](/docs/reference/providers#supported-dns-providers)）。
- 支持 140+ 部署目标（如 Kubernetes、CDN、WAF、负载均衡等，[点此查看完整清单](/docs/reference/providers#supported-hosting-providers)）。
